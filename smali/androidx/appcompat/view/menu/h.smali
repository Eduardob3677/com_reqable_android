...
.method public final a()Lj/d;
    ...
    invoke-virtual {v0, v1}, Lj/d;->u(Landroid/widget/PopupWindow$OnDismissListener;)V
    ...
    invoke-virtual {v0, v1}, Lj/d;->r(Z)V

    iget v1, p0, Landroidx/appcompat/view/menu/h;->g:I

    invoke-virtual {v0, v1}, Lj/d;->s(I)V
...
.method public g(Z)V
    ...
    invoke-virtual {v0, p1}, Lj/d;->r(Z)V
...
.method public final l(IIZZ)V
    ...
    invoke-virtual {v0, p4}, Lj/d;->v(Z)V
    ...
    invoke-static {p4}, Lc0/j0;->r(Landroid/view/View;)I

    move-result p4

    invoke-static {p3, p4}, Lc0/e;->a(II)I
    ...
    :cond_0
    invoke-virtual {v0, p1}, Lj/d;->t(I)V

    invoke-virtual {v0, p2}, Lj/d;->w(I)V
    ...
    invoke-virtual {v0, p4}, Lj/d;->q(Landroid/graphics/Rect;)V
