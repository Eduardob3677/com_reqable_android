...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/b;->l:Lk/t1;
...
.method public final F(Landroidx/appcompat/view/menu/e;)V
    ...
    invoke-static {p1}, Lj/d;->x(Landroidx/appcompat/view/menu/e;)Z
    ...
    invoke-static {v1, v5, v2, v4}, Lj/d;->o(Landroid/widget/ListAdapter;Landroid/view/ViewGroup;Landroid/content/Context;I)I

    move-result v2

    invoke-virtual {p0}, Landroidx/appcompat/view/menu/b;->z()Lk/w1;

    move-result-object v4

    invoke-virtual {v4, v1}, Lk/p1;->p(Landroid/widget/ListAdapter;)V

    invoke-virtual {v4, v2}, Lk/p1;->B(I)V

    iget v1, p0, Landroidx/appcompat/view/menu/b;->n:I

    invoke-virtual {v4, v1}, Lk/p1;->C(I)V
    ...
    invoke-virtual {v4, v7}, Lk/w1;->Q(Z)V

    invoke-virtual {v4, v5}, Lk/w1;->N(Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, v6}, Lk/p1;->z(Landroid/view/View;)V
    ...
    :goto_6
    invoke-virtual {v4, v12}, Lk/p1;->l(I)V

    invoke-virtual {v4, v3}, Lk/p1;->I(Z)V

    invoke-virtual {v4, v8}, Lk/p1;->j(I)V
    ...
    invoke-virtual {v4, v2}, Lk/p1;->l(I)V
    ...
    invoke-virtual {v4, v2}, Lk/p1;->j(I)V

    :cond_b
    invoke-virtual {p0}, Lj/d;->n()Landroid/graphics/Rect;

    move-result-object v2

    invoke-virtual {v4, v2}, Lk/p1;->D(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v2, v4, p1, v3}, Landroidx/appcompat/view/menu/b$d;-><init>(Lk/w1;Landroidx/appcompat/view/menu/e;I)V

    iget-object v3, p0, Landroidx/appcompat/view/menu/b;->i:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v4}, Lk/p1;->a()V

    invoke-virtual {v4}, Lk/p1;->g()Landroid/widget/ListView;
...
.method public b(Landroidx/appcompat/view/menu/e;Z)V
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/b$d;->a:Lk/w1;

    invoke-virtual {v1, v2}, Lk/w1;->O(Ljava/lang/Object;)V

    iget-object v1, v0, Landroidx/appcompat/view/menu/b$d;->a:Lk/w1;

    invoke-virtual {v1, v3}, Lk/p1;->A(I)V

    :cond_2
    iget-object v0, v0, Landroidx/appcompat/view/menu/b$d;->a:Lk/w1;
...
.method public dismiss()V
    ...
    iget-object v3, v2, Landroidx/appcompat/view/menu/b$d;->a:Lk/w1;

    invoke-virtual {v3}, Lk/p1;->c()Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v2, v2, Landroidx/appcompat/view/menu/b$d;->a:Lk/w1;

    invoke-virtual {v2}, Lk/p1;->dismiss()V
...
.method public f(Z)V
    ...
    invoke-static {v0}, Lj/d;->y(Landroid/widget/ListAdapter;)Landroidx/appcompat/view/menu/d;
...
.method public onDismiss()V
    ...
    iget-object v4, v3, Landroidx/appcompat/view/menu/b$d;->a:Lk/w1;

    invoke-virtual {v4}, Lk/p1;->c()Z
...
.method public p(Landroid/view/View;)V
    ...
    invoke-static {p1}, Lc0/j0;->r(Landroid/view/View;)I

    move-result p1

    invoke-static {v0, p1}, Lc0/e;->a(II)I
...
.method public final z()Lk/w1;
    ...
    invoke-direct {v0, v1, v4, v2, v3}, Lk/w1;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/b;->l:Lk/t1;

    invoke-virtual {v0, v1}, Lk/w1;->P(Lk/t1;)V

    invoke-virtual {v0, p0}, Lk/p1;->H(Landroid/widget/AdapterView$OnItemClickListener;)V

    invoke-virtual {v0, p0}, Lk/p1;->G(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/b;->o:Landroid/view/View;

    invoke-virtual {v0, v1}, Lk/p1;->z(Landroid/view/View;)V

    iget v1, p0, Landroidx/appcompat/view/menu/b;->n:I

    invoke-virtual {v0, v1}, Lk/p1;->C(I)V

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Lk/p1;->F(Z)V

    const/4 v1, 0x2

    invoke-virtual {v0, v1}, Lk/p1;->E(I)V
