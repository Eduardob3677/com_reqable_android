...
.method private static getCellSignalLevel()I
    ...
    :try_start_1
    invoke-static {v1}, Lo8/m;->c(Landroid/telephony/TelephonyManager;)Landroid/telephony/SignalStrength;

    move-result-object v1

    if-eqz v1, :cond_0

    invoke-static {v1}, Lorg/chromium/base/q;->a(Landroid/telephony/SignalStrength;)I
...
.method private static isWifiConnected()Z
    ...
    invoke-static {v1}, Lo8/d;->a(Landroid/net/ConnectivityManager;)Landroid/net/Network;
