...
.method public g(Landroid/util/AttributeSet;)V
    ...
    invoke-static {v0, p1, v1}, Lk/i2;->t(Landroid/content/Context;Landroid/util/AttributeSet;[I)Lk/i2;
    ...
    invoke-virtual {p1, v0, v1}, Lk/i2;->m(II)I
    ...
    invoke-virtual {p1, v0, v2}, Lk/i2;->j(II)I
    ...
    invoke-virtual {p1, v2, v3}, Lk/i2;->j(II)I
    ...
    invoke-virtual {p1, v0}, Lk/i2;->o(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1, v0}, Lk/i2;->n(I)Ljava/lang/String;
    ...
    invoke-virtual {p1, v0}, Lk/i2;->r(I)Z

    move-result v2

    if-eqz v2, :cond_0

    invoke-virtual {p1, v0, v1}, Lk/i2;->a(IZ)Z
    ...
    invoke-virtual {p1, v0, v2}, Lk/i2;->a(IZ)Z
    ...
    iput-object v0, p0, Li/g$b;->A:Lc0/b;
    ...
    :cond_3
    iput-object v4, p0, Li/g$b;->A:Lc0/b;
    ...
    invoke-virtual {p1, v0}, Lk/i2;->c(I)Landroid/content/res/ColorStateList;
...
.method public final i(Landroid/view/MenuItem;)V
    ...
    :cond_8
    :goto_3
    iget-object v0, p0, Li/g$b;->A:Lc0/b;

    if-eqz v0, :cond_9

    invoke-static {p1, v0}, Lc0/x;->a(Landroid/view/MenuItem;Lc0/b;)Landroid/view/MenuItem;

    :cond_9
    iget-object v0, p0, Li/g$b;->B:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Lc0/x;->c(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-object v0, p0, Li/g$b;->C:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Lc0/x;->g(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-char v0, p0, Li/g$b;->n:C

    iget v1, p0, Li/g$b;->o:I

    invoke-static {p1, v0, v1}, Lc0/x;->b(Landroid/view/MenuItem;CI)V

    iget-char v0, p0, Li/g$b;->p:C

    iget v1, p0, Li/g$b;->q:I

    invoke-static {p1, v0, v1}, Lc0/x;->f(Landroid/view/MenuItem;CI)V

    iget-object v0, p0, Li/g$b;->E:Landroid/graphics/PorterDuff$Mode;

    if-eqz v0, :cond_a

    invoke-static {p1, v0}, Lc0/x;->e(Landroid/view/MenuItem;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, v0}, Lc0/x;->d(Landroid/view/MenuItem;Landroid/content/res/ColorStateList;)V
