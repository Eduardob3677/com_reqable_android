...
.field public final b:Lr5/j;

.field public final c:Lio/flutter/plugin/platform/h$d;

.field public d:Lr5/j$j;

.field public e:I

.field public final f:Lr5/j$h;


# direct methods
.method public constructor <init>(Landroid/app/Activity;Lr5/j;Lio/flutter/plugin/platform/h$d;)V
    .locals 1
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/h;->f:Lr5/j$h;

    iput-object p1, p0, Lio/flutter/plugin/platform/h;->a:Landroid/app/Activity;

    iput-object p2, p0, Lio/flutter/plugin/platform/h;->b:Lr5/j;

    invoke-virtual {p2, v0}, Lr5/j;->l(Lr5/j$h;)V
...
.method public static synthetic a(Lio/flutter/plugin/platform/h;Lr5/j$i;)V
    .locals 0

    invoke-virtual {p0, p1}, Lio/flutter/plugin/platform/h;->s(Lr5/j$i;)V
...
.method public static synthetic c(Lio/flutter/plugin/platform/h;Lr5/j$e;)Ljava/lang/CharSequence;
    .locals 0

    invoke-virtual {p0, p1}, Lio/flutter/plugin/platform/h;->r(Lr5/j$e;)Ljava/lang/CharSequence;
...
.method public static synthetic g(Lio/flutter/plugin/platform/h;)Lr5/j;
    .locals 0

    iget-object p0, p0, Lio/flutter/plugin/platform/h;->b:Lr5/j;

    return-object p0
.end method

.method public static synthetic h(Lio/flutter/plugin/platform/h;Lr5/j$c;)V
    .locals 0

    invoke-virtual {p0, p1}, Lio/flutter/plugin/platform/h;->x(Lr5/j$c;)V
...
.method public static synthetic j(Lio/flutter/plugin/platform/h;Lr5/j$k;)V
    .locals 0

    invoke-virtual {p0, p1}, Lio/flutter/plugin/platform/h;->z(Lr5/j$k;)V
...
.method public static synthetic m(Lio/flutter/plugin/platform/h;Lr5/j$j;)V
    .locals 0

    invoke-virtual {p0, p1}, Lio/flutter/plugin/platform/h;->C(Lr5/j$j;)V
...
.method public final C(Lr5/j$j;)V
    .locals 9
    ...
    new-instance v2, Lc0/a2;

    invoke-direct {v2, v0, v1}, Lc0/a2;-><init>(Landroid/view/Window;Landroid/view/View;)V
    ...
    iget-object v3, p1, Lr5/j$j;->b:Lr5/j$d;
    ...
    :cond_1
    invoke-virtual {v2, v4}, Lc0/a2;->b(Z)V

    goto :goto_0

    :cond_2
    invoke-virtual {v2, v6}, Lc0/a2;->b(Z)V

    :cond_3
    :goto_0
    iget-object v3, p1, Lr5/j$j;->a:Ljava/lang/Integer;
    ...
    :cond_4
    iget-object v3, p1, Lr5/j$j;->c:Ljava/lang/Boolean;
    ...
    iget-object v3, p1, Lr5/j$j;->e:Lr5/j$d;
    ...
    :cond_6
    invoke-virtual {v2, v4}, Lc0/a2;->a(Z)V

    goto :goto_1

    :cond_7
    invoke-virtual {v2, v6}, Lc0/a2;->a(Z)V

    :cond_8
    :goto_1
    iget-object v2, p1, Lr5/j$j;->d:Ljava/lang/Integer;
    ...
    :cond_9
    iget-object v2, p1, Lr5/j$j;->f:Ljava/lang/Integer;
    ...
    :cond_a
    iget-object v2, p1, Lr5/j$j;->g:Ljava/lang/Boolean;
    ...
    :cond_b
    iput-object p1, p0, Lio/flutter/plugin/platform/h;->d:Lr5/j$j;
...
.method public E()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/h;->d:Lr5/j$j;

    if-eqz v0, :cond_0

    invoke-virtual {p0, v0}, Lio/flutter/plugin/platform/h;->C(Lr5/j$j;)V

    :cond_0
    return-void
.end method

.method public F(Lr5/j$g;)V
    .locals 3
...
.method public q()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/h;->b:Lr5/j;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lr5/j;->l(Lr5/j$h;)V

    return-void
.end method

.method public final r(Lr5/j$e;)Ljava/lang/CharSequence;
    .locals 6
    ...
    sget-object v2, Lr5/j$e;->b:Lr5/j$e;
    ...
    invoke-static {v0, p1}, Le5/b;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, p1}, Le5/b;->h(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final s(Lr5/j$i;)V
    .locals 1

    sget-object v0, Lr5/j$i;->b:Lr5/j$i;
...
.method public final t()V
    ...
    invoke-interface {v0}, Landroidx/activity/k;->j()Landroidx/activity/OnBackPressedDispatcher;
...
.method public final x(Lr5/j$c;)V
    .locals 7
    ...
    iget-object v4, p1, Lr5/j$c;->b:Ljava/lang/String;

    const/4 v5, 0x0

    iget v6, p1, Lr5/j$c;->a:I
    ...
    iget-object v1, p1, Lr5/j$c;->b:Ljava/lang/String;

    const/4 v2, 0x0

    iget p1, p1, Lr5/j$c;->a:I
...
.method public final z(Lr5/j$k;)V
    .locals 1

    sget-object v0, Lr5/j$k;->b:Lr5/j$k;
    ...
    :cond_0
    sget-object v0, Lr5/j$k;->c:Lr5/j$k;
    ...
    :cond_1
    sget-object v0, Lr5/j$k;->d:Lr5/j$k;
    ...
    :cond_2
    sget-object v0, Lr5/j$k;->e:Lr5/j$k;
