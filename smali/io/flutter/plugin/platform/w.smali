...
.field public final i:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Ljava/lang/Integer;",
            "Lio/flutter/plugin/platform/a0;",
            ">;"
        }
    .end annotation
.end field
...
.field public final t:Lf5/b0;

.field public u:Z

.field public final v:Lr5/l$g;
...
.method public static constructor <clinit>()V
    ...
    sput-object v1, Lio/flutter/plugin/platform/w;->w:[Ljava/lang/Class;

    sput-boolean v0, Lio/flutter/plugin/platform/w;->x:Z

    sput-boolean v3, Lio/flutter/plugin/platform/w;->y:Z
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/w;->v:Lr5/l$g;
    ...
    invoke-static {}, Lf5/b0;->a()Lf5/b0;

    move-result-object v0

    iput-object v0, p0, Lio/flutter/plugin/platform/w;->t:Lf5/b0;

    return-void
.end method

.method public static synthetic A(Lio/flutter/plugin/platform/w;Lio/flutter/plugin/platform/k;Lr5/l$d;)J
    .locals 0

    invoke-virtual {p0, p1, p2}, Lio/flutter/plugin/platform/w;->J(Lio/flutter/plugin/platform/k;Lr5/l$d;)J
...
.method public static synthetic B(Lio/flutter/plugin/platform/w;)Landroid/util/SparseArray;
    .locals 0
...
.method private synthetic Z(Lr5/l$d;Landroid/view/View;Z)V
    .locals 0

    if-eqz p3, :cond_0

    iget-object p2, p0, Lio/flutter/plugin/platform/w;->g:Lr5/l;

    iget p1, p1, Lr5/l$d;->a:I

    invoke-virtual {p2, p1}, Lr5/l;->d(I)V

    goto :goto_0

    :cond_0
    iget-object p2, p0, Lio/flutter/plugin/platform/w;->f:Lio/flutter/plugin/editing/m;
...
.method private synthetic a0(Lr5/l$d;Landroid/view/View;Z)V
    .locals 0
...
.method private synthetic c0()V
    ...
    invoke-virtual {p0, v0}, Lio/flutter/plugin/platform/w;->U(Z)V
...
.method public static e0(Lio/flutter/view/TextureRegistry;)Lio/flutter/plugin/platform/o;
    ...
    invoke-static {v2, v0}, Le5/b;->e(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v0, Lio/flutter/plugin/platform/x;

    invoke-direct {v0, p0}, Lio/flutter/plugin/platform/x;-><init>(Lio/flutter/view/TextureRegistry$SurfaceProducer;)V
    ...
    invoke-direct {v0, p0}, Lio/flutter/plugin/platform/z;-><init>(Lio/flutter/view/TextureRegistry$SurfaceTextureEntry;)V

    return-object v0
.end method

.method public static synthetic f(Lio/flutter/plugin/platform/w;Lr5/l$d;Landroid/view/View;Z)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lio/flutter/plugin/platform/w;->a0(Lr5/l$d;Landroid/view/View;Z)V

    return-void
.end method

.method public static synthetic g(Lio/flutter/plugin/platform/w;Lr5/l$d;Landroid/view/View;Z)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lio/flutter/plugin/platform/w;->Z(Lr5/l$d;Landroid/view/View;Z)V
...
.method public static synthetic i(Lio/flutter/plugin/platform/w;I)V
    .locals 0

    invoke-virtual {p0, p1}, Lio/flutter/plugin/platform/w;->S(I)V

    return-void
.end method

.method public static synthetic j(Lio/flutter/plugin/platform/w;Lr5/l$d;)V
    .locals 0

    invoke-virtual {p0, p1}, Lio/flutter/plugin/platform/w;->T(Lr5/l$d;)V

    return-void
.end method

.method public static synthetic k(Lio/flutter/plugin/platform/w;)Landroid/util/SparseArray;
    .locals 0
...
.method public static synthetic l(Lio/flutter/plugin/platform/w;D)I
    .locals 0

    invoke-virtual {p0, p1, p2}, Lio/flutter/plugin/platform/w;->w0(D)I
...
.method public static synthetic m(Lio/flutter/plugin/platform/w;)F
    .locals 0

    invoke-virtual {p0}, Lio/flutter/plugin/platform/w;->V()F
...
.method public static synthetic n(Lio/flutter/plugin/platform/w;Lio/flutter/plugin/platform/a0;)V
    .locals 0

    invoke-virtual {p0, p1}, Lio/flutter/plugin/platform/w;->d0(Lio/flutter/plugin/platform/a0;)V

    return-void
.end method

.method public static n0(Ljava/lang/Object;F)Landroid/view/MotionEvent$PointerCoords;
    .locals 5
...
.method public static synthetic o(Lio/flutter/plugin/platform/w;D)I
    .locals 0

    invoke-virtual {p0, p1, p2}, Lio/flutter/plugin/platform/w;->t0(D)I
...
.method public static o0(Ljava/lang/Object;F)Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v1, p1}, Lio/flutter/plugin/platform/w;->n0(Ljava/lang/Object;F)Landroid/view/MotionEvent$PointerCoords;
...
.method public static synthetic p(Lio/flutter/plugin/platform/w;)Landroid/content/Context;
    .locals 0
...
.method public static p0(Ljava/lang/Object;)Landroid/view/MotionEvent$PointerProperties;
    .locals 2
...
.method public static synthetic q(I)Z
    ...
    invoke-static {p0}, Lio/flutter/plugin/platform/w;->y0(I)Z
...
.method public static q0(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {v1}, Lio/flutter/plugin/platform/w;->p0(Ljava/lang/Object;)Landroid/view/MotionEvent$PointerProperties;
...
.method public static synthetic r(Lio/flutter/plugin/platform/w;Z)Z
    .locals 0
...
.method public static synthetic s(Lio/flutter/plugin/platform/w;Lio/flutter/plugin/platform/a0;)V
    .locals 0

    invoke-virtual {p0, p1}, Lio/flutter/plugin/platform/w;->x0(Lio/flutter/plugin/platform/a0;)V

    return-void
.end method

.method public static synthetic t(Lio/flutter/plugin/platform/w;DF)I
    .locals 0

    invoke-virtual {p0, p1, p2, p3}, Lio/flutter/plugin/platform/w;->u0(DF)I
...
.method public static synthetic u(Lio/flutter/plugin/platform/w;Lio/flutter/plugin/platform/k;Lr5/l$d;)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lio/flutter/plugin/platform/w;->H(Lio/flutter/plugin/platform/k;Lr5/l$d;)V

    return-void
.end method

.method public static synthetic v(Lio/flutter/plugin/platform/w;)Landroid/util/SparseArray;
    .locals 0
...
.method public static synthetic w(Lio/flutter/plugin/platform/w;)Lio/flutter/view/TextureRegistry;
    .locals 0
...
.method public static synthetic x(Lio/flutter/plugin/platform/w;)Lf5/r;
    .locals 0

    iget-object p0, p0, Lio/flutter/plugin/platform/w;->d:Lf5/r;
...
.method public static synthetic z(Lio/flutter/plugin/platform/w;)Z
    .locals 0
...
# virtual methods
.method public C(Landroid/content/Context;Lio/flutter/view/TextureRegistry;Lh5/a;)V
    .locals 1
    ...
    invoke-direct {p1, p3}, Lr5/l;-><init>(Lh5/a;)V

    iput-object p1, p0, Lio/flutter/plugin/platform/w;->g:Lr5/l;

    iget-object p2, p0, Lio/flutter/plugin/platform/w;->v:Lr5/l$g;

    invoke-virtual {p1, p2}, Lr5/l;->e(Lr5/l$g;)V
...
.method public D(Lio/flutter/plugin/editing/m;)V
    ...
    iput-object p1, p0, Lio/flutter/plugin/platform/w;->f:Lio/flutter/plugin/editing/m;
...
.method public E(Lio/flutter/embedding/engine/renderer/FlutterRenderer;)V
    ...
    invoke-direct {v0, p1, v1}, Lf5/c;-><init>(Lio/flutter/embedding/engine/renderer/FlutterRenderer;Z)V

    iput-object v0, p0, Lio/flutter/plugin/platform/w;->b:Lf5/c;

    return-void
.end method

.method public F(Lf5/r;)V
    .locals 3

    iput-object p1, p0, Lio/flutter/plugin/platform/w;->d:Lf5/r;
    ...
    iget-object v2, p0, Lio/flutter/plugin/platform/w;->d:Lf5/r;
    ...
    iget-object v1, p0, Lio/flutter/plugin/platform/w;->d:Lf5/r;

    invoke-interface {v0, v1}, Lio/flutter/plugin/platform/k;->d(Landroid/view/View;)V
...
.method public final H(Lio/flutter/plugin/platform/k;Lr5/l$d;)V
    .locals 1
    ...
    invoke-static {p2, p1}, Le5/b;->e(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public I(Lio/flutter/plugin/platform/k;Lr5/l$d;)J
    .locals 9
    ...
    invoke-virtual {p0, v0}, Lio/flutter/plugin/platform/w;->S(I)V
    ...
    invoke-static {v1, v0}, Le5/b;->e(Ljava/lang/String;Ljava/lang/String;)V

    iget-wide v0, p2, Lr5/l$d;->c:D

    invoke-virtual {p0, v0, v1}, Lio/flutter/plugin/platform/w;->w0(D)I

    move-result v0

    iget-wide v1, p2, Lr5/l$d;->d:D

    invoke-virtual {p0, v1, v2}, Lio/flutter/plugin/platform/w;->w0(D)I
    ...
    :goto_0
    iget-object v5, p0, Lio/flutter/plugin/platform/w;->b:Lf5/c;

    invoke-virtual {v2, v5}, Lio/flutter/plugin/platform/p;->setTouchProcessor(Lf5/c;)V
    ...
    iget-wide v6, p2, Lr5/l$d;->e:D

    invoke-virtual {p0, v6, v7}, Lio/flutter/plugin/platform/w;->w0(D)I

    move-result v6

    iget-wide v7, p2, Lr5/l$d;->f:D

    invoke-virtual {p0, v7, v8}, Lio/flutter/plugin/platform/w;->w0(D)I
    ...
    invoke-interface {p1}, Lio/flutter/plugin/platform/k;->c()Landroid/view/View;
    ...
    invoke-direct {v0, p0, p2}, Lio/flutter/plugin/platform/t;-><init>(Lio/flutter/plugin/platform/w;Lr5/l$d;)V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/w;->d:Lf5/r;
    ...
    invoke-virtual {p0, p1}, Lio/flutter/plugin/platform/w;->f0(Lio/flutter/plugin/platform/k;)V

    return-wide v3
.end method

.method public final J(Lio/flutter/plugin/platform/k;Lr5/l$d;)J
    .locals 10
    ...
    iget v7, p2, Lr5/l$d;->a:I

    new-instance v9, Lio/flutter/plugin/platform/u;

    invoke-direct {v9, p0, p2}, Lio/flutter/plugin/platform/u;-><init>(Lio/flutter/plugin/platform/w;Lr5/l$d;)V
    ...
    invoke-static/range {v1 .. v9}, Lio/flutter/plugin/platform/a0;->a(Landroid/content/Context;Lio/flutter/plugin/platform/a;Lio/flutter/plugin/platform/k;Lio/flutter/plugin/platform/o;IIILjava/lang/Object;Landroid/view/View$OnFocusChangeListener;)Lio/flutter/plugin/platform/a0;
    ...
    iget-object v1, p2, Lr5/l$d;->b:Ljava/lang/String;
...
.method public K()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    iget-object v3, p0, Lio/flutter/plugin/platform/w;->d:Lf5/r;
    ...
    invoke-virtual {p0, v0}, Lio/flutter/plugin/platform/w;->L(Lio/flutter/plugin/platform/d;)Lio/flutter/embedding/engine/FlutterOverlaySurface;
...
.method public L(Lio/flutter/plugin/platform/d;)Lio/flutter/embedding/engine/FlutterOverlaySurface;
    .locals 2
    .annotation build Landroid/annotation/TargetApi;
        value = 0x13
    .end annotation
    ...
    invoke-virtual {p1}, Lf5/k;->getSurface()Landroid/view/Surface;
...
.method public M(Lr5/l$d;Z)Lio/flutter/plugin/platform/k;
    .locals 3
    .annotation build Landroid/annotation/TargetApi;
        value = 0x13
    .end annotation
    ...
    iget-object v1, p1, Lr5/l$d;->b:Ljava/lang/String;
    ...
    iget-object v2, p1, Lr5/l$d;->i:Ljava/nio/ByteBuffer;

    if-eqz v2, :cond_0

    invoke-virtual {v0}, Lio/flutter/plugin/platform/l;->b()Ls5/h;

    move-result-object v1

    iget-object v2, p1, Lr5/l$d;->i:Ljava/nio/ByteBuffer;

    invoke-interface {v1, v2}, Ls5/h;->b(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
    ...
    invoke-interface {p2}, Lio/flutter/plugin/platform/k;->c()Landroid/view/View;

    move-result-object v0

    if-eqz v0, :cond_2

    iget v1, p1, Lr5/l$d;->g:I
    ...
    invoke-virtual {p0, p2}, Lio/flutter/plugin/platform/w;->f0(Lio/flutter/plugin/platform/k;)V
    ...
    iget-object p1, p1, Lr5/l$d;->b:Ljava/lang/String;
...
.method public O()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/w;->g:Lr5/l;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    invoke-virtual {v0, v1}, Lr5/l;->e(Lr5/l$g;)V

    :cond_0
    invoke-virtual {p0}, Lio/flutter/plugin/platform/w;->N()V

    iput-object v1, p0, Lio/flutter/plugin/platform/w;->g:Lr5/l;
...
.method public P()V
    ...
    invoke-virtual {p0}, Lio/flutter/plugin/platform/w;->r0()V

    const/4 v1, 0x0

    iput-object v1, p0, Lio/flutter/plugin/platform/w;->d:Lf5/r;
    ...
    invoke-interface {v1}, Lio/flutter/plugin/platform/k;->e()V
...
.method public Q()V
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/w;->f:Lio/flutter/plugin/editing/m;
...
.method public final R()V
    ...
    iget-object v1, p0, Lio/flutter/plugin/platform/w;->v:Lr5/l$g;

    invoke-interface {v1, v0}, Lr5/l$g;->h(I)V
...
.method public final T(Lr5/l$d;)V
    .locals 3

    iget v0, p1, Lr5/l$d;->g:I

    invoke-static {v0}, Lio/flutter/plugin/platform/w;->y0(I)Z
...
.method public final U(Z)V
    ...
    invoke-virtual {v2, v4}, Lf5/r;->m(Lf5/k;)V

    invoke-virtual {v4}, Lf5/k;->e()Z
...
.method public X(I)V
    ...
    :cond_0
    invoke-interface {v0}, Lio/flutter/plugin/platform/k;->c()Landroid/view/View;
    ...
    iget-object v4, p0, Lio/flutter/plugin/platform/w;->b:Lf5/c;

    invoke-direct {v1, v2, v3, v4}, Lk5/a;-><init>(Landroid/content/Context;FLf5/c;)V
    ...
    invoke-virtual {v1, v2}, Lk5/a;->setOnDescendantFocusChangeListener(Landroid/view/View$OnFocusChangeListener;)V
    ...
    iget-object p1, p0, Lio/flutter/plugin/platform/w;->d:Lf5/r;
...
.method public c(I)Landroid/view/View;
    ...
    invoke-virtual {p1}, Lio/flutter/plugin/platform/a0;->f()Landroid/view/View;
...
.method public final d0(Lio/flutter/plugin/platform/a0;)V
    .locals 1

    iget-object v0, p0, Lio/flutter/plugin/platform/w;->f:Lio/flutter/plugin/editing/m;
    ...
    invoke-virtual {p1}, Lio/flutter/plugin/platform/a0;->g()V

    return-void
.end method

.method public final f0(Lio/flutter/plugin/platform/k;)V
    .locals 1
    ...
    invoke-static {p1, v0}, Le5/b;->e(Ljava/lang/String;Ljava/lang/String;)V

    return-void

    :cond_0
    invoke-interface {p1, v0}, Lio/flutter/plugin/platform/k;->d(Landroid/view/View;)V
...
.method public i0()V
    ...
    invoke-virtual {p0}, Lio/flutter/plugin/platform/w;->R()V
...
.method public j0(IIIII)V
    ...
    invoke-virtual {p0}, Lio/flutter/plugin/platform/w;->Y()V
...
.method public k0(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    invoke-virtual/range {v1 .. v6}, Lk5/a;->a(Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;IIII)V
    ...
    invoke-interface {p3}, Lio/flutter/plugin/platform/k;->c()Landroid/view/View;
...
.method public l0()V
    ...
    invoke-virtual {v0, v1}, Lf5/r;->A(Ljava/lang/Runnable;)V
    ...
    :cond_1
    invoke-virtual {p0, v1}, Lio/flutter/plugin/platform/w;->U(Z)V
...
.method public final r0()V
    ...
    invoke-static {v0, v1}, Le5/b;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final t0(D)I
    ...
    invoke-virtual {p0, p1, p2, v0}, Lio/flutter/plugin/platform/w;->u0(DF)I
...
.method public v0(FLr5/l$f;Z)Landroid/view/MotionEvent;
    .locals 19

    move-object/from16 v0, p2

    iget-wide v1, v0, Lr5/l$f;->p:J

    invoke-static {v1, v2}, Lf5/b0$a;->c(J)Lf5/b0$a;

    move-result-object v1

    move-object/from16 v2, p0

    iget-object v3, v2, Lio/flutter/plugin/platform/w;->t:Lf5/b0;

    invoke-virtual {v3, v1}, Lf5/b0;->b(Lf5/b0$a;)Landroid/view/MotionEvent;
    ...
    :cond_0
    iget-object v1, v0, Lr5/l$f;->f:Ljava/lang/Object;

    invoke-static {v1}, Lio/flutter/plugin/platform/w;->q0(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v1

    iget v3, v0, Lr5/l$f;->e:I
    ...
    iget-object v1, v0, Lr5/l$f;->g:Ljava/lang/Object;

    move/from16 v3, p1

    invoke-static {v1, v3}, Lio/flutter/plugin/platform/w;->o0(Ljava/lang/Object;F)Ljava/util/List;
    ...
    iget-object v1, v0, Lr5/l$f;->b:Ljava/lang/Number;

    invoke-virtual {v1}, Ljava/lang/Number;->longValue()J

    move-result-wide v3

    iget-object v1, v0, Lr5/l$f;->c:Ljava/lang/Number;

    invoke-virtual {v1}, Ljava/lang/Number;->longValue()J

    move-result-wide v5

    iget v7, v0, Lr5/l$f;->d:I

    iget v8, v0, Lr5/l$f;->e:I

    iget v11, v0, Lr5/l$f;->h:I

    iget v12, v0, Lr5/l$f;->i:I

    iget v13, v0, Lr5/l$f;->j:F

    iget v14, v0, Lr5/l$f;->k:F

    iget v15, v0, Lr5/l$f;->l:I

    iget v1, v0, Lr5/l$f;->m:I

    iget v2, v0, Lr5/l$f;->n:I

    iget v0, v0, Lr5/l$f;->o:I
...
.method public final x0(Lio/flutter/plugin/platform/a0;)V
    .locals 1
    ...
    invoke-virtual {p1}, Lio/flutter/plugin/platform/a0;->h()V
